...
## Relaying
### VM 1
- Use this technique if you have an unprivilged user and a NTLM hash you can't crack.
- Can relay the hash to another machine where the user is a local admin
- target needs UAC disabled
- 
...
- create a SMB connection (random directory) to kali
- incoming connection will be seen in ntlm relay tab
```
...
- once we request our SMB on kali, shell will be caught
```
nc -nvlp 4444
```
