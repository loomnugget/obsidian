# start with initial active scan
sudo nmap -p80  -sV 192.168.50.20

# do initial fingerprinting
sudo nmap -p80 --script=http-enum 192.168.208.52

# Gain more info: https://www.wappalyzer.com/

# once you find a running web server, the next step is to map publicly accessible files and directories
gobuster dir -u 192.168.208.16 -w /usr/share/wordlists/dirb/common.txt -t 5

# burpsuite - firefox about:preferences#general
...
gobuster dir -u http://192.168.208.52:80 -w /usr/share/wordlists/dirb/big.txt -p pattern
...
# common XSS starting points
< > ' " { } ;

# compress JS to one line: https://jscompress.com/
# this works
